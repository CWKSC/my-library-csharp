...
namespace MyLib_Csharp.CommonClass
{
    public static class MyLoop
    {
        ...
        public static void Loop(this (int start, int end) args, Action action) => Loop(args, (_) => action());
        ...
        public static void Loop(this (int start, int end, int step) args, Action action) => Loop(args, (_) => action());
